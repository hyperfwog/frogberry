...
import { http, type Block, type Chain, createPublicClient, webSocket } from 'viem';
...
const pollingIntervalMs = Number.parseInt(process.env.POLLING_INTERVAL_MS || '1000', 10);
